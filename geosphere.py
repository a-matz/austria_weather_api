...
class GeosphereAPI:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Austria Weather API')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'AustriaWeatherAPI')
        self.toolbar.setObjectName(u'AustriaWeatherAPI')

        #print "** INITIALIZING GeosphereAPI"
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/geosphere/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Austria Weather API'),
            callback=self.run,
